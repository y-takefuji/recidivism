...
ax1.plot(years, chi2_county, label='Chi-squared (County)', linestyle='-', linewidth=2, color='black')
ax1.plot(years, chi2_gender, label='Chi-squared (Gender)', linestyle=':', linewidth=2, color='black')
ax1.plot(years, chi2_age, label='Chi-squared (Age)', linestyle='--', linewidth=2, color='black')
ax1.set_xlabel('Year')
...
ax2 = ax1.twinx()
ax2.plot(years, p_county, label='P-value (County)', linestyle='-', linewidth=1, color='black')
ax2.plot(years, p_gender, label='P-value (Gender)', linestyle=':', linewidth=1, color='black')
ax2.plot(years, p_age, label='P-value (Age)', linestyle='--', linewidth=1, color='black')
